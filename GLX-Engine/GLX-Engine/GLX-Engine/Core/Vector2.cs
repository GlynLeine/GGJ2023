...
namespace GLXEngine.Core
{
    public struct Vector2
    {
        ...
        public static Vector2 Null() { return new Vector2(float.NegativeInfinity, float.NegativeInfinity); }
        ...
        { return a == null ? Null() : (a.Length < 2 ? throw new Exception("Float array has fewer numbers than the array.") : new Vector2(a[0], a[1])); }
